...
def lan_g(input_image):
    ...
    with tf.compat.v1.variable_scope("generator"):
        ...
        dam1 = _double_att(x_c, activation, mid_activation='none', end_activation=end_activation, reduction=4,
                           multiplier=2)
        dam1 = x_c + dam1

        dam2 = _double_att(dam1, activation, mid_activation='none', end_activation=end_activation, reduction=4,
                           multiplier=2)
        dam2 = dam1 + dam2
...
def _conv_layer(net, num_filters, filter_size, strides, norm='none', padding='SAME', activation='none', use_bias=True,
                sn=False, actfirst=False):
...
def _double_att(input, activation='relu', mid_activation='none', end_activation='sigmoid', norm='none', reduction=1,
                multiplier=1):
